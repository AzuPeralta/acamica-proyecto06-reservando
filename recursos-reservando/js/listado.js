...
Listado.prototype.obtenerCiudades = function() {
    ...
    let ciudades = this.restaurantes.map(restaurantes => restaurantes.ubicacion);
    let nuevasCiudades = ciudades.filter(valoresSinRepetir);
...
Listado.prototype.obtenerRubro = function() {
    ...
    var nuevosRubros = rubros.filter(valoresSinRepetir);
    return nuevosRubros.sort();
}
...
function valoresSinRepetir(elem, index, self){
